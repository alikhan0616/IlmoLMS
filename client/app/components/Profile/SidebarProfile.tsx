    ...
    <div className="w-full">
      <div
        className={`w-full flex items-center px-3 py-4 cursor-pointer ${
          active === 1 ? "dark:bg-slate-800 bg-indigo-50" : "bg-transparent"
        }`}
        onClick={() => setActive(1)}
      >
        <Image
      ...
      <div
        className={`w-full flex items-center px-3 py-4 cursor-pointer ${
          active === 2 ? "dark:bg-slate-800 bg-indigo-50" : "bg-transparent"
        } `}
        onClick={() => setActive(2)}
      >
      ...
      <div
        className={`w-full flex items-center px-3 py-4 cursor-pointer ${
          active === 3 ? "dark:bg-slate-800 bg-indigo-50" : "bg-transparent"
        } `}
        onClick={() => setActive(3)}
      >
